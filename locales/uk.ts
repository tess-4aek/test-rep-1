export default {
  ...
  emailPasswordRequired: 'Електронна пошта та пароль обов\'язкові',
  checkEmail: 'Перевірте вашу пошту',
  confirmationEmailSent: 'Лист підтвердження надіслано на вашу електронну адресу',
  authError: 'Сталася помилка автентифікації',
  googleAuthError: 'Помилка автентифікації через Google',
  appleAuthError: 'Помилка автентифікації через Apple',
  appleAuthIosOnly: 'Вхід через Apple доступний лише на iOS',
  alreadyHaveAccount: 'Вже маєте акаунт? Увійдіть',
  dontHaveAccount: 'Немає акаунту? Зареєструйтеся',
