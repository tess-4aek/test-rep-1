  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>{t('settings')}</Text>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>{t('changeLanguage')}</Text>
