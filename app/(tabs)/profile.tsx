    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={styles.heading} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>{t('profile')}</Text>
        </View>
          ...
          {menuItems.map((item, index) => (
            ...
            >
              ...
              <View style={styles.menuContent}>
                <Text style={styles.menuTitle} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>{item.title}</Text>
                <Text style={styles.menuSubtitle} adjustsFontSizeToFit numberOfLines={2} minimumFontScale={0.7}>{item.subtitle}</Text>
              </View>
        ...
        <View style={styles.logoutContainer}>
          <TouchableOpacity style={styles.logoutButton} onPress={handleLogout}>
            ...
            <Text style={styles.logoutText} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>{t('signOut')}</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
